...
Game.Launch=function()
{
	...
	Game.Init=function()
	{
		...
		Game.cookiesEarned=1000000000000000000;//all cookies earned during gameplay
		Game.cookies=1000000000000000000;//cookies
		Game.cookiesd=1000000000000000000;//cookies display
		Game.cookiesPs=1000000000000000000;//cookies per second (to recalculate with every new purchase)
		Game.cookiesReset=1000000000000000000;//cookies lost to resetting
		Game.frenzy=1000000000000000000;//as long as >0, cookie production is multiplied by frenzyPower
		Game.frenzyPower=1000000000000000000;
